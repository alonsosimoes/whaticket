  ...
  pt: {
    translations: {
      ...
      settings: {
        ...
        fail: "Erro ao salvar a configuração.",
        title: "Configurações",
        settings: {
          userCreation: {
      ...
      backendErrors: {
        ...
        ERR_UNABLE_PERFORM_OPERATION: "Não foi possível realizar a operação",
        ERR_NUMBER_REQUIRED:"O número é obrigatório",
      },
    },
  },
};
